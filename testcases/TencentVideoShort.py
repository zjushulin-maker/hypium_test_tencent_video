...
#==================================================================
#文 件 名：                 TencentVideoShort.py
#文件说明：                 腾讯视频测试用例：打开应用，跳过广告，切换到短视频界面并滑动（短视频滑动）
#作    者：                 author
#生成日期：                 2025-12-11
#!!================================================================
"""
...
class TencentVideoShort(TencentVideoBase):
    def __init__(self, controllers):
        super().__init__(controllers)
        # 可自定义滑动次数，基准30次，压测时乘以 stress_multiplier
        self.swipe_count = 30 * self.stress_multiplier
        # pmap采样间隔时间（秒），默认1秒
    ...
    def process(self):
        ...
        Step('4.切换到短视频界面')
        # 点击坐标(482, 2525)切换到短视频界面
        self.driver.touch((482, 2525))
        time.sleep(1)  # 等待界面切换
